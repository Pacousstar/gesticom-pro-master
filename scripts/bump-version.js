 ...
 * 
 * Logique:
 * - 3.41.X : X va de 0 a 20 (20 releases par mineure)
 * - Apres 3.41.20 -> 3.42.0
 * - 3.42.X : X va de 0 a 20
 * - Apres 3.42.20 -> 3.43.0
 * - ...
 * 
...
function main() {
  ...
  console.log(`[bump-version] Progression: ${v.patch}/20 sur mineur ${v.minor}`)
}
